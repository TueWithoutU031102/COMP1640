                    ...
                    <section class="create-idea">
                        ...
                        <form action="{{ route('storeIdea') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="description" name="description" value="{{old('description')}}"
                                          class="form-control" id="discussion" aria-describedby="description"
                                          rows="4"></textarea>
                            </div>
                            <br>
                            <div class="form-group">
                            ...
                            <br>
                            <div class="form-group">
                                <input type="radio" id="isAnonymous" name="isAnonymous">
                                <label for="isAnonymous" class="font-weight-bold">Anonymous</label>
                            </div>
                            <br>
                            <div class="form-group">
                                <input type="checkbox" name="checkbox" value='1'>
                                <label for="title" class="font-weight-bold">I Accept All <a
                                        href="/terms&condition#8">Terms and Condition</a></label>
                            </div>
                            <br>
                                            ...
                                            @if ($idea->author_id == Auth::user()->id || Auth::user()->id == 1)
                                                <li>
                                                    <a onclick="return confirm('Are {{ $idea->user->name }} sure to delete {{ $idea->title }} !!!???')"
                                                       href="/idea/delete/{{ $idea->id }}">Remove Post</a>
                                                </li>
                                            @endif
                                        </ul>
                                    </div>
                                ...
                                <div class="user-detail">
                                    @if($idea->isAnonymous)
                                        ...
                                        <div class="post-content">
                                            ...
                                            <small>Anonymous Has Posted on {{ $idea->created_at }}</small>
                                            ...
                                            @else
                                                ...
                                                <div class="post-content">
                                                    ...
                                                    <small>{{ $idea->user->name }} Has Posted
                                                        on {{ $idea->created_at }}</small>
                                                    @endif
                                                    <br>
                        ...
                        <div class="submission-information">
                            ...
                            @if (Auth::user()->role_id == 1)
                                ...
                                <button class="btn btn-primary" id="submitEditDateButton"
                                        onclick="updateDate('{{ $submission->id }}')" hidden>
                                    Ok
                                </button>
